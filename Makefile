...
LIBS = -lMsftedit -lcomctl32 -lgdiplus -lgdi32 -luser32 -lws2_32 -liphlpapi -I"./HEADER" -I"C:/Program Files/OpenSSL-Win64/include" -L"C:/Program Files/OpenSSL-Win64/lib/VC/x64/MT" -lssl -lcrypto -fpermissive
...
$(OBJ_DIR)/HANDLE/ClientHandler.o: $(HEADER_DIR)/ClientHandler.hpp $(HEADER_DIR)/BlackList.hpp $(HEADER_DIR)/Logger.hpp $(HEADER_DIR)/ThreadPool.hpp $(HEADER_DIR)/UI.hpp
$(OBJ_DIR)/HANDLE/HttpHandler.o: $(HEADER_DIR)/HttpHandler.hpp $(HEADER_DIR)/Logger.hpp $(HEADER_DIR)/UI.hpp
